...
v = main_window.VentanaPrincipal(demo=(modo == "demo"))
v.resize(1040, 700)
v.show()

def capturar():
    pagina = v.pila.currentWidget()
    tabs = pagina.findChildren(type(pagina)) if False else None
    from PySide6.QtWidgets import QTabWidget
    for tw in pagina.findChildren(QTabWidget):
